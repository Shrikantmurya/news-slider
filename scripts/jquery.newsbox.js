...
(function ($, w, d, undefined) {
    ...
    var NewsBox = {
        ...
        findcardObject: function () {
            var card = this.$elem;

            while (card.parent() !== undefined) {
                card = card.parent();
                if (card.parent().hasClass('card')) {
                    return card.parent();
                }
            }
        ...
        buildNavigation: function () {
            ...
            if (card) {
                ...
                if (footer) {
                    ...
                    $(card).append('<div class="card-footer">' + nav + '</div>');
                }

                var self = this;
                $(card).find('.prev').on('click', function (ev) {
                    ev.preventDefault();
                    self.onPrev();
                });

                $(card).find('.next').on('click', function (ev) {
                    ev.preventDefault();
                    self.onNext();
                });
